...
import com.lee.library.view.banner.listener.OnBannerListener;
import com.lee.library.view.banner.loader.ImageLoaderInterface;
import com.lee.library.view.banner.view.BannerViewPager;
...
/**
 * 源码来自于github 开源项目 https://github.com/youth5201314/banner
 */
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.lib_view_banner;
