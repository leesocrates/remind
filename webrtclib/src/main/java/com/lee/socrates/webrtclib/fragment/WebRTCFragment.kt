 ...
 */
class WebRTCFragment : BaseFragment() {
    ...
    private fun onIceCandidateReceived(peer: PeerConnection?, iceCandidate: IceCandidate?) {
        ...
        send(SignalMessage(MESSAGE_TYPE_ICECANDIDATE, candidate = iceCandidate))
    }
    ...
    private fun handleMessage(message: String?) {
        ...
        when (signalMessage?.type) {
            ...
            MESSAGE_TYPE_ICECANDIDATE -> handleIceCandidateMessage(signalMessage)
        }
    }
    ...
    companion object {
        ...
        private val MESSAGE_TYPE_ICECANDIDATE = "iceCandidate"
    }
